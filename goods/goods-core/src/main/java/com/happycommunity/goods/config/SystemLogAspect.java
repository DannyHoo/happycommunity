package com.happycommunity.goods.config;
...
public class SystemLogAspect {
    ...
    public SystemLogAspect() {
        ...
        logTraceAspect.setBizService("com.happycommunity.goods");
        logTraceAspect.setLogger("com.happycommunity.goods.service");
    }

    /**
     * 定义一个切入点
     */
    @Pointcut("execution(* com.happycommunity.goods.service..*.*(..)) or execution(* com.happycommunity.goods.dao..*.*(..))")
